...
// Data object containing all the hardcoded content
const cardData = {
    hero: {
        icon: Wrench,
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className = "relative group">
                        ...
                        <div className="absolute bottom-8 left-8">
                            ...
                            ${cardData.styling.button.borderRadius} font-semibold ${cardData.styling.button.hover} transition-all flex items-center space-x-2 hover:scale-105 hover:shadow-lg`}>
                                <span>{cardData.hero.buttonText}</span>
                                <div className="animate-bounce">
                                    {cardData.hero.buttonIcon}
                                </div>
                            </button>
                        </div>
                    </div>
